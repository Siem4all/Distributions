...
# https://docs.amd.com/r/2.0-English/ug1333-ai-optimizer/ResNet18
...
# Create a ResNet18 model and add the pruning APIs to perform pruning.
...
# From the second round onwards, model analysis is no longer required. Increase the pruning ratio and use the sparse checkpoint saved from previous round as the pretrained weights.
